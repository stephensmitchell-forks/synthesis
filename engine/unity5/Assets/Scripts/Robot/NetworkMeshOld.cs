...
public class NetworkMeshOld : MonoBehaviour
{
    ...
    {
        deltaPosition = newPosition - intPosition;//transform.position;
        deltaRotation = newRotation * intRotation;//transform.rotation;
